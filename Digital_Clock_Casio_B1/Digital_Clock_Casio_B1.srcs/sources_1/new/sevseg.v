module sevseg (
  ...
  localparam MAX_COUNT = 500000;  // khoảng 200Hz refresh

  reg [3:0] cur_value;

  always @(posedge clk) begin
    // quét digit
    if (counter < MAX_COUNT) counter <= counter + 1;
    else begin
      counter <= 0;
      digit_index <= digit_index + 1;
    end

    // chọn giá trị đang hiển thị
    case (digit_index)
    ...
    // MAPPING 7 đoạn (common anode - active low)
    case (cur_value)
      ...
      default: IO_SSEG <= 7'b1111111;  // blank
    endcase
