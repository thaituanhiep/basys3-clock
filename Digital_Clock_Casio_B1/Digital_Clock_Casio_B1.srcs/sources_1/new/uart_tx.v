`timescale 1ns / 1ps
// =====================================================
// uart_tx: 8N1 transmitter (no parity, 1 stop)
// - tx_start: 1-cycle pulse to start sending tx_data
// - tx_busy : high while sending (start + 8 data + stop)
// - tx      : serial output, IDLE = 1 (HIGH)
// =====================================================
module uart_tx #(
