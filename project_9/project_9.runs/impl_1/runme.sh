...
HD_PWD='C:/Users/thait/project_9/project_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_clock_7seg_basys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_clock_7seg_basys3.tcl -notrace
