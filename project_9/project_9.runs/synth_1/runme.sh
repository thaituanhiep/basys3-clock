...
HD_PWD='C:/Users/thait/project_9/project_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_clock_7seg_basys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_clock_7seg_basys3.tcl
